 ...
 return (
      ...
      <div className="grid lg:fixed   md:fixed shadow-sm z-10 bg-blue-400 fixed lg:h-[70px] h-16 w-full   grid-cols-12">
       ...
       <img className=" p-2 align-middle lg:h-[70px] h-16 w-20" src="dr.jpeg"></img>
        ...
        <li className="hover:cursor-pointer text-base font-bold px-2 py-1 rounded-tl-xl text-ellipsis whitespace-nowrap rounded-br-xl hover:bg-white" onClick={docterbutton}>docter team</li>
        {/* <li className="hover:cursor-pointer text-base font-bold px-2 py-1 rounded-tl-xl text-ellipsis whitespace-nowrap rounded-br-xl hover:bg-white" onClick={corporatebutton}>our corporate</li> */}
        <li className="hover:cursor-pointer text-base font-bold px-2 py-1 rounded-tl-xl text-ellipsis whitespace-nowrap rounded-br-xl hover:bg-white" onClick={gallerybutton}>gallery</li>
        ...
        {/* <li className="hover:cursor-pointer text-base font-bold px-2 py-1 rounded-tl-xl text-ellipsis whitespace-nowrap rounded-br-xl hover:bg-white" onClick={healthbutton}>health checkup plan</li> */}
        </ul>
