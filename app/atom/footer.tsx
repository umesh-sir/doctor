            ...
            <div className="grid grid-cols-12 bg-slate-500 p-2">
                ...
                <div className="lg:col-span-3 md:col-span-3 col-span-6 text-white text-center p-2">
                    ...
                    <div className="text-lg mt-1 flex justify-center">
                        ...
                        />
                        <span className="text-base hover:cursor-pointer hover:scale-110 -mt-1 ml-2 font-semibold">Instagram</span>
                    </div>
                    <a className="text-lg mt-1 -ml-1 flex justify-center" href="https://wa.me/9887242595">
                        <Image
                            ...
                            height={20}
                        />
                        <span className="text-base hover:cursor-pointer hover:scale-110 -mt-1 ml-2 font-semibold">WhatsApp</span>
                    </a>
                    <div className="text-lg mt-1 -ml-1 flex justify-center">
                        ...
                        />
                        <span className="text-base hover:cursor-pointer hover:scale-110 -mt-1 ml-2 font-semibold">Facebook</span>
                    </div>
                    <div className="text-lg mt-1 -ml-4 flex justify-center">
                        ...
                        />
                        <span className="text-base hover:cursor-pointer hover:scale-110 -mt-1 ml-2 font-semibold">YouTube</span>
                    </div>
                    <div className="text-lg mt-1 -ml-6 flex justify-center">
                        ...
                        />
                        <span className="text-base hover:cursor-pointer hover:scale-110 -mt-1 ml-2 font-semibold">Twitter</span>
                    </div>
                </div>
